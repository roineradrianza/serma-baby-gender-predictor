<div ref="serma_gthfp_container" class="container md:border border-gray-300 rounded-2xl px-4 md:px-0">
        ...
        <div class="hidden md:inline col-span-2 px-3 md:px-3 pt-4 pb-6 bg-cover"
            ...
            <div class="baby-comment-box pt-1 px-1">
                <h2 class="text-18px md:text-[24px] text-center md:text-left text-black font-semibold mb-2">
                    Sexo del niño por factor <span
                        class="font-['Cookie'] text-purple-lighten font-normal text-40px">RH</span></h2>
            </div>
            <img class="pb-3 max-w-[208px] mx-auto"
                src="<?= SERMA_BABY_GENDER_PREDICTOR_URL ?>/assets/img/rh-factor-parent-bg.png">
        </div>
        ...
        <div class="bg-yellow-lighten md:col-span-4 p-3 md:p-6 rounded-2xl">
            <form method="post">
                <h2
                    ...
                    Sexo del niño por factor <span
                        class="font-['Cookie'] text-purple-lighten font-normal text-[28px]">RH</span></h2>
                ...
                <div class="mb-3">
                    ...
                    <div class="flex mt-3 gap-y-2">
                        <label class="w-full md:w-auto">
                            <input checked type="radio" v-model="form.father_rh" name="father_rh" class="hidden peer"
                                value="1" />
                            <div
                        ...
                        <label class="w-full md:w-auto">
                            <input type="radio" v-model="form.father_rh" name="father_rh" class="hidden peer" value="2" />
                            <div
                                class="peer-checked:border-green-lighten peer-checked:text-green-lighten peer-checked:font-semibold 
                                peer-checked:border-2 bg-white peer-checked:px-5 peer-checked:py-1.5 py-2 md:peer-checked:py-1 md:py-1.5 px-6 mr-2 text-center text-13px md:text-16px rounded-full">
                                Negativo</div>
                ...
                <div class="mb-3">
                    ...
                    <div class="flex mt-3 gap-y-2">
                        <label class="w-full md:w-auto">
                            <input checked type="radio" v-model="form.mother_rh" name="mother_rh" class="hidden peer"
                                value="1" />
                            <div
                                class="peer-checked:border-green-lighten peer-checked:text-green-lighten peer-checked:font-semibold 
                                peer-checked:border-2 bg-white peer-checked:px-5 peer-checked:py-1.5 py-2 md:peer-checked:py-1 md:py-1.5 px-6 mr-2 text-center text-13px md:text-16px rounded-full">
                        ...
                        <label class="w-full md:w-auto">
                            <input type="radio" v-model="form.mother_rh" name="mother_rh" class="hidden peer" value="2" />
                            <div
                                class="peer-checked:border-green-lighten peer-checked:text-green-lighten peer-checked:font-semibold 
                                peer-checked:border-2 bg-white peer-checked:px-5 peer-checked:py-1.5 py-2 md:peer-checked:py-1 md:py-1.5 px-6 mr-2 text-center text-13px md:text-16px rounded-full">
                                Negativo</div>
...
<?= SERMA_BABY_GENDER_PREDICTOR_TEMPLATE::show_template('rh-factor-parent/form/results') ?>